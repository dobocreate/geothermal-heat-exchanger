...
if page == "計算ツール":
    ...
    with st.expander("📌 ステップ3: 熱伝達係数の計算"):
        ...
        **hi**: 管内側熱伝達係数 [W/m²·K]<br>
        **Nu**: ヌセルト数 [-]<br>
        **kwater**: 水の熱伝導率 [W/m·K]<br>
        **D**: 配管内径 [m]
    ...
    with st.expander("📌 ステップ4: 総括熱伝達係数の計算"):
        ...
        **Ui**: 内径基準の総括熱伝達係数 [W/m²·K]<br>
        **hi**: 管内側熱伝達係数 [W/m²·K]<br>
        **ri**: 配管内半径 [m]<br>
        **ro**: 配管外半径 [m]<br>
        **kpipe**: 配管材の熱伝導率 [W/m·K]<br>
        **ho**: 管外側熱伝達係数 [W/m²·K]
    ...
    with st.expander("📌 ステップ7: 地下水温度上昇の計算（オプション）"):
        ...
        **Vgw**: 地下水体積 [m³]<br>
        **Vboring**: ボーリング孔体積 [m³] = π(Dboring²/4)L<br>
        **Vpipes**: 配管総体積 [m³]（U字管なので2倍）<br>
        **Dboring**: ボーリング孔径 [m]<br>
        **L**: 管浸水距離 [m]
        ...
        **ΔTgw,limited**: 制限後の地下水温度上昇 [K]<br>
        **ΔTgw**: 計算された地下水温度上昇 [K]<br>
        **ΔTlimit**: ユーザー設定の上限値 [K]（5-20℃）<br>
        **min()**: 最小値を選択する関数
        """)
    ...
    with st.expander("📌 ステップ8: 最終計算と結果の評価"):
        ...
        **Tground,final**: 最終地下水温度 [℃]<br>
        **Tground,initial**: 初期地下水温度 [℃]<br>
        **ΔTgw**: 地下水温度上昇 [K]<br>
        **Tout,final**: 最終出口温度 [℃]<br>
        **Tin**: 入口温度 [℃]<br>
        **ε**: 熱交換効率 [-]
        """)
